...
import * as app from '../src/server/checkerService.js'; // Our app
...
describe('compare two images', () => {
  ...
  it('should be equal!', async () => {
    ...
    return app.performGMAnalysis(session, fileNames, options).then((res) => {
      // console.log(res);
  ...
  it('should not be equal!', async () => {
    ...
    return app
      .performGMAnalysis(session, fileNames, options)
      .then((res) => {
        // console.log(res);
